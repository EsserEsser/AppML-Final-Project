...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "map_relative_error_heatmap_300.png"), dpi=150)
plt.close()
print("Saved map_relative_error_heatmap_300.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "map_relative_error_overlay_300.png"), dpi=150)
plt.close()
print("Saved map_relative_error_overlay_300.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "map_relative_error_smooth_300.png"), dpi=150)
plt.close()
print("Saved map_relative_error_smooth_300.png")
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "map_relative_error_smooth_sidebyside_300.png"), dpi=150)
plt.close()
print("Saved map_relative_error_smooth_sidebyside_300.png")